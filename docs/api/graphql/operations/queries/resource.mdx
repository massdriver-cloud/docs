...
#### [<code style={{ fontWeight: 'normal' }}>resource.<b>organizationId</b></code>](#organization-id)<Bullet />[<code style={{ fontWeight: 'normal' }}><b>ID!</b></code>](/api/graphql/types/scalars/id.mdx) <Badge class="badge badge--secondary badge--non_null" text="non-null"/> <Badge class="badge badge--secondary " text="scalar"/> \{#organization-id\} 
...
#### [<code style={{ fontWeight: 'normal' }}><b>Resource</b></code>](/api/graphql/types/objects/resource.mdx) <Badge class="badge badge--secondary " text="object"/> 
