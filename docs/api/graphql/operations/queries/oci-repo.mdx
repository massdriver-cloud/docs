...
#### [<code style={{ fontWeight: 'normal' }}>ociRepo.<b>organizationId</b></code>](#organization-id)<Bullet />[<code style={{ fontWeight: 'normal' }}><b>ID!</b></code>](/api/graphql/types/scalars/id.mdx) <Badge class="badge badge--secondary badge--non_null" text="non-null"/> <Badge class="badge badge--secondary " text="scalar"/> \{#organization-id\} 
...
#### [<code style={{ fontWeight: 'normal' }}><b>OciRepo</b></code>](/api/graphql/types/objects/oci-repo.mdx) <Badge class="badge badge--secondary " text="object"/> 
