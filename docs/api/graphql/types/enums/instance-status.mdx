...
[`Instance`](/api/graphql/types/objects/instance.mdx)  <Badge class="badge badge--secondary badge--relation" text="object"/><Bullet />[`InstanceStatusFilter`](/api/graphql/types/inputs/instance-status-filter.mdx)  <Badge class="badge badge--secondary badge--relation" text="input"/>