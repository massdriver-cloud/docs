...
#### [<code style={{ fontWeight: 'normal' }}>Organization.<b>settings</b></code>](#settings)<Bullet />[<code style={{ fontWeight: 'normal' }}><b>OrganizationSettings</b></code>](/api/graphql/types/objects/organization-settings.mdx) <Badge class="badge badge--secondary " text="object"/> \{#settings\} 
