...
#### [<code style={{ fontWeight: 'normal' }}>CostSample.<b>amount</b></code>](#amount)<Bullet />[<code style={{ fontWeight: 'normal' }}><b>Float</b></code>](/api/graphql/types/scalars/float.mdx) <Badge class="badge badge--secondary " text="scalar"/> \{#amount\} 
The cost in the given currency. Null when no billing data is available for this period.


#### [<code style={{ fontWeight: 'normal' }}>CostSample.<b>currency</b></code>](#currency)<Bullet />[<code style={{ fontWeight: 'normal' }}><b>String</b></code>](/api/graphql/types/scalars/string.mdx) <Badge class="badge badge--secondary " text="scalar"/> \{#currency\} 
...
[`CostSummary`](/api/graphql/types/objects/cost-summary.mdx)  <Badge class="badge badge--secondary badge--relation" text="object"/>