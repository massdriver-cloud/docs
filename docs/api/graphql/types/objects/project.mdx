...
type Project {
  ...
  links: [Link!]!
  blueprint: Blueprint @deprecated
}
```
...
#### [<code style={{ fontWeight: 'normal' }}>Project.<b>components</b></code>](#components)<Bullet />[<code style={{ fontWeight: 'normal' }}><b>[Component!]!</b></code>](/api/graphql/types/objects/component.mdx) <Badge class="badge badge--secondary badge--non_null" text="non-null"/> <Badge class="badge badge--secondary " text="object"/> \{#components\} 
Components that make up the project's infrastructure architecture.


#### [<code style={{ fontWeight: 'normal' }}>Project.<b>links</b></code>](#links)<Bullet />[<code style={{ fontWeight: 'normal' }}><b>[Link!]!</b></code>](/api/graphql/types/objects/link.mdx) <Badge class="badge badge--secondary badge--non_null" text="non-null"/> <Badge class="badge badge--secondary " text="object"/> \{#links\} 
...
#### [<code style={{ fontWeight: 'normal' }}>Project.<b>blueprint</b></code>](#blueprint)<Bullet />[<code style={{ fontWeight: 'normal' }}><b>Blueprint</b></code>](/api/graphql/types/objects/blueprint.mdx) <Badge class="badge badge--secondary badge--deprecated" text="deprecated"/> <Badge class="badge badge--secondary " text="object"/> \{#blueprint\} 
:::warning[DEPRECATED]

Use the top-level `components` and `links` fields on `Project` instead.

:::

The architectural design of components and links for this project.
