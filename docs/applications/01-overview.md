...
* Ability to generate environment variables via the application [package's](/concepts/manifests-packages-deployments) parameters or [connections](/concepts/connections).
