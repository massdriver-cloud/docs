...
* Ability to generate environment variables via the application [package's](/concepts/components-instances-deployments) parameters or [connections](/concepts/connections).
