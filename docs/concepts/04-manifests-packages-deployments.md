...
Instances surface alarms in the **Monitor** tab of the instance pane. Click any component on the canvas, open **Monitor**, and Massdriver lists the alarms wired up for that instance — provisioner-generated by default and extendable per bundle.
